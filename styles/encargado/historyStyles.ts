...
export const historyStyles = StyleSheet.create({
  ...
  // HEADER CON GRADIENTE - COMPACTO (IGUAL AL REPORTANTE)
  headerContainer: {
  ...
  // STATS CARDS - MÁS ANCHAS (solo ancho)
  statsContainer: {
    flexDirection: 'row',
  ...
  // FILTROS DESPLEGABLES - MÁS ANCHOS (solo ancho)
  filtersContainer: {
    flexDirection: 'row',
    gap: 12,
  ...
  // DESCRIPCIÓN (IGUAL AL REPORTANTE)
  descriptionText: {
    fontFamily: 'Roboto_400Regular',
    fontSize: 14, // Mantenido igual
    color: '#475569',
    lineHeight: 20,
    marginBottom: 12,
  },
  ...
  // FOOTER DE TARJETA (IGUAL AL REPORTANTE)
  reportFooter: {
    flexDirection: 'row',
    justifyContent: 'space-between',
    alignItems: 'center',
  ...
  statusText: {
    fontFamily: 'Roboto_500Medium',
    fontSize: 12, // Mantenido igual
    color: '#475569',
    textTransform: 'capitalize',
  },
  
  // BOTONES DE ACCIÓN - AJUSTADOS PARA ENCARGADO
  actionsContainer: {
    flexDirection: 'row',
    gap: 12,
    marginTop: 16,
  ...
  userIconContainer: {
    position: 'absolute',
    top: 16, // Mantenido igual
    right: 16, // Mantenido igual
  },
  
  // MODALES (IGUAL AL REPORTANTE)
  modalOverlay: {
    flex: 1,
