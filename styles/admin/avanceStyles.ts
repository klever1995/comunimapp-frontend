...
export const avanceStyles = StyleSheet.create({
  ...
  // STATS CARDS - NUEVO (IGUAL A OTRAS PANTALLAS)
  statsContainer: {
    flexDirection: 'row',
  ...
  // INFORMACIÓN DEL REPORTE - IGUAL A OTRAS PANTALLAS
  reportInfoCard: {
  ...
  // BOTÓN DE ELIMINAR - ESPECÍFICO PARA ADMIN
  deleteButton: {
